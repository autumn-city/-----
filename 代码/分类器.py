...
def judge_right():
    i=0
    j=0
    for info in os.listdir(r'/Users/yangchengran/Desktop/单独文章-数据集的副本/同仁堂致歉/wechat/'):
        domain = os.path.abspath(r'/Users/yangchengran/Desktop/单独文章-数据集的副本/同仁堂致歉/wechat/') #获取文件夹的路径，此处其实没必要这么写，目的是为了熟悉os的文件夹操作
        ...
        with open(info) as createVar['intern '+str(j)]:
            ...
            outputs = open('/Users/yangchengran/Desktop/单独文章-数据集的副本/同仁堂致歉/wechatresult/' + str(j) + '.txt', 'w',
                           encoding='UTF-8')
            ...
            outputs.close()
            seg=open('/Users/yangchengran/Desktop/单独文章-数据集的副本/同仁堂致歉/wechatresult/' + str(j) + '.txt',
                           encoding='UTF-8').read()
            print(seg+"-----seg")
